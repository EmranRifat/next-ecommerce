...
const AuthProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (cartData) {
      ...
      const flatCartData = JSON.parse(cartData).flat(); // Flatten the array
      dispatch({ type: actionTypes.ADD_TO_CARD, payload: flatCartData });
      setLocalStorageData(flatCartData);
  ...
  useEffect(() => {
    const flatCartData = state.cart.flat();
